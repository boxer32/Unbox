...
} from "./chunk-U2JGUEQU.js";
import "./chunk-5B5S5KML.js";
import "./chunk-SHHPUYXA.js";
import {
  __export
...
function verify2(options) {
  ...
  return secp256r12.verify(signature, payload instanceof Uint8Array ? payload : fromHex(payload), toHex2(publicKey).substring(2), { lowS: true, ...hash4 ? { prehash: true } : {} });
}
    ...
    if (envelope) {
      if ((envelope == null ? void 0 : envelope.type) === "keychain" && mode2 === "allowAccessKey") {
        ...
        if (keyInfo.expiry <= BigInt(Math.floor(Date.now() / 1e3)))
          return false;
        const innerPayload = envelope.version === "v2" ? keccak256(concat2("0x04", hash4, address)) : hash4;
