...
// ../../node_modules/@tanstack/router-devtools-core/dist/BaseTanStackRouterDevtoolsPanel-qCkSGZav.js
var tokens = {
  colors: {
    inherit: "inherit",
...
function Explorer({ value, defaultExpanded, pageSize = 100, filterSubEntries, ...rest }) {
  ...
  const subEntries = createMemo(() => {
    ...
    if (Array.isArray(value())) entries = value().map((d, i2) => makeProperty({
      label: i2.toString(),
      value: d
    }));
...
//# sourceMappingURL=chunk-4JPBYPKP.js.map
