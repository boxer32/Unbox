  ...
  mount(el) {
    ...
    const dispose = render(() => {
      ...
      if (__privateGet(this, _Component)) Devtools = __privateGet(this, _Component);
        ...
        Devtools = lazy(() => import("./FloatingTanStackRouterDevtools-Dz-7tBRe-MIGKUU4B.js"));
  ...
  mount(el) {
    ...
    const dispose = render(() => {
      ...
      if (__privateGet(this, _Component2)) BaseTanStackRouterDevtoolsPanel = __privateGet(this, _Component2);
        ...
        BaseTanStackRouterDevtoolsPanel = lazy(() => import("./BaseTanStackRouterDevtoolsPanel-qCkSGZav-7PVYHWSW.js"));
